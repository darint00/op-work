...
import (
	...
	actianv1beta1 "my.domain/api/v1beta1"
)

// InformixReconciler reconciles a Informix object
type InformixReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=actian.my.domain,resources=informixes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=actian.my.domain,resources=informixes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=actian.my.domain,resources=informixes/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the Informix object against the actual cluster state, and then
...
func (r *InformixReconciler) SetupWithManager(mgr ctrl.Manager) error {
